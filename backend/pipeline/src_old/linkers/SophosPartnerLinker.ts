import { BaseLinker } from "src_old/linkers/BaseLinker.js";
import { natsClient } from "src_old/lib/nats.js";
...
export class SophosPartnerLinker extends BaseLinker {
  ...
  async start(): Promise<void> {
    ...
    Debug.log({
      ...
      context: "start",
      message:
        "Linker started and subscribed to processed events for firewalls and licenses",
    });
  }
   ...
   */
  private async handleFirewallLicenseLinking(
