...
import { AnalysisContext, AnalyzerResult, AlertType, AlertSeverity, Alert, EntityState } from "src/types.js";
...
export abstract class BaseAnalyzer {
    ...
    protected setState(
        ...
        if (!existing || this.getStatePriority(state) > this.getStatePriority(existing)) {
