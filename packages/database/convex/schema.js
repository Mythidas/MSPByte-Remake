...
export const entityTypeValidator = v.union(v.literal("companies"), v.literal("endpoints"), v.literal("identities"), v.literal("firewalls"), v.literal("groups"), v.literal("roles"), v.literal("policies"), v.literal("licenses"));
export default defineSchema({
    ...
    integrations: defineTable({
        ...
        supportedTypes: v.array(v.object({
    ...
    data_sources: defineTable({
        ...
        // Pagination tracking
        syncStatus: v.optional(v.union(v.literal("idle"), v.literal("syncing_batch"), v.literal("syncing_final"), v.literal("error"))),
    ...
    scheduled_jobs: defineTable({
        ...
        status: v.union(v.literal("pending"), v.literal("running"), v.literal("completed"), v.literal("failed"), v.literal("broken")),
    ...
    entity_alerts: defineTable({
        ...
        status: v.union(v.literal("active"), v.literal("resolved"), v.literal("suppressed")),
