...
export function DataTableFilters<T>({
  ...
  const renderValueInput = (filter: DataTableFilter, index?: number) => {
    ...
    const isNullOperator = filter.operator === "is" || filter.operator === "not.is";
                            ...
                            <DropdownMenuItem
                              ...
                              onClick={() =>
                                updateFilter(index, {
                                  ...
                                  value:
                                    operator.value === "is" || operator.value === "not.is"
                                      ? "null"
                                      : filter.value,
                                })
                              }
          ...
          <div>
                      ...
                      <DropdownMenuItem
                        ...
                        onClick={() =>
                          setNewFilter((prev) => ({
                            ...
                            operator:
                              operator.value as DataTableFilter["operator"],
                            value: operator.value === "is" || operator.value === "not.is" ? "null" : undefined,
                          }))
                        }
                      >
                        {operator.label}
            ...
            <Button
              ...
              disabled={
                !newFilter.column ||
                !newFilter.operator ||
                (!newFilter.value && newFilter.operator !== "is" && newFilter.operator !== "not.is")
              }
              size="sm"
              className="w-full"
            >
