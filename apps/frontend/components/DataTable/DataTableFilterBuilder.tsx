...
export function DataTableFilterBuilder<TData>({ columns, onAddFilter }: DataTableFilterBuilderProps<TData>) {
    ...
    const handleFieldChange = (field: string) => {
        ...
        if (column?.filter) {
            ...
            if (column.filter.type === "boolean") {
                setValue(false);
            } else if (column.filter.type === "select" && (column.filter.operators[0] === "in" || column.filter.operators[0] === "nin")) {
                setValue([]);
            } else {
                setValue("");
            }
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>Create a new filter to narrow down your results.</DialogDescription>
                </DialogHeader>
