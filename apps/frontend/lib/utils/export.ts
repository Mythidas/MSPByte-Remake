 ...
 * @returns CSV string
 */
export function convertToCSV<T>(data: T[], columns: DataTableColumn<T>[]): string {
 ...
 */
export function convertToJSON<T>(data: T[], columns: DataTableColumn<T>[]): string {
    if (!data.length) return '[]';
 ...
 */
export function exportToCSV<T>(data: T[], columns: DataTableColumn<T>[], filename: string = 'export') {
 ...
 * @param filename Name of the file (without extension)
 */
export function exportToJSON<T>(data: T[], columns: DataTableColumn<T>[], filename: string = 'export') {
