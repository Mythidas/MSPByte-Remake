        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="bg-card/50 border rounded shadow p-4 flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              <span className="text-2xl font-semibold">{totalConnections}</span>
            </div>
            <Link
          ...
          <div className="bg-card/50 border rounded shadow p-4 flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              <span className="text-2xl font-semibold">{totalSitesLinked}</span>
            </div>
            {totalSitesLinked > 0 && (
            ...
            <div className="flex items-center gap-2">
              <span className="text-2xl font-semibold">
                {mostRecentConnection
                  ? new Date(
                      mostRecentConnection._creationTime,
                    ).toLocaleDateString()
                  : "N/A"}
              </span>
            </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-muted-foreground">
                        {config.tenantName} • {domainCount} domain
                        {domainCount !== 1 ? "s" : ""} mapped
                      </span>
                    </div>
                  </div>
        ...
        <div className="bg-card/50 border rounded shadow p-8 flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground max-w-lg">
              Configure your Microsoft 365 integration to start syncing users,
              groups, licenses, and more from your Entra tenants. The setup
      ...
      {hasConfiguration && totalConnections === 0 && (
        <div className="bg-card/50 border rounded shadow p-8 flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground max-w-lg">
              Create your first Microsoft 365 connection to start syncing data
              from an Entra tenant.
            </p>
          </div>
          <Link href="/secure/default/integrations/microsoft-365/connections">
            <Button size="lg" className="gap-2">
