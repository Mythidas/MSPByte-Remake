    ...
    const steps: WizardStep[] = [
        {
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Button
                                ...
                                disabled={connectionStatus === 'testing' || !config.url || !config.apiKey || !config.apiSecretKey}
                                className="gap-2"
                            >
            ...
            component: (
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="relative">
                            <Input
                                ...
                                onChange={(e) => setConfig({ ...config, apiSecretKey: e.target.value })}
                                className="bg-input border-border pr-10"
                            />
                            <Button
                                type="button"
                            ...
                            >
                                {showApiSecretKey ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                            </Button>
                        </div>
                    </div>
                    ...
                    {/* Site Variable Name */}
                    <div className="flex flex-col gap-2">
                        <Label htmlFor="siteVariableName">Site Variable Name (Optional)</Label>
                        <Input
                            id="siteVariableName"
                            type="text"
                            placeholder="MSPSiteCode"
                            value={config.siteVariableName}
                            onChange={(e) => setConfig({ ...config, siteVariableName: e.target.value })}
                            className="bg-input border-border"
                        />
                        <p className="text-xs text-muted-foreground">
                            The variable name to push MSPByte site IDs to (default: MSPSiteCode)
                        </p>
                    </div>
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="bg-card/30 border rounded p-4 flex flex-col gap-3">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                            ...
                            <div>
                                <span className="text-muted-foreground">Site Variable Name:</span>
                                <p className="font-medium">{config.siteVariableName || 'MSPSiteCode'}</p>
                            </div>
