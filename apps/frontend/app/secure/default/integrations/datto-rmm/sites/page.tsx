...
export default function DattoRMMSites() {
    ...
    const transformedSites = useMemo(() => {
        ...
        return sites.map((site: any) => {
            ...
            const linkedMSPSite = allMSPSites.find((mspSite: any) =>
                mspSite.rmmIntegrationId === integration._id &&
    ...
    const availableMSPSites = useMemo(() => {
        ...
        return allMSPSites.filter((site: any) => !site.rmmIntegrationId || site.rmmIntegrationId !== integration._id);
    }, [allMSPSites, integration]);
    ...
    const handleLink = async (dattoSiteId: string, mspSiteId: string) => {
        ...
        try {
            ...
            toast.success(`Linked ${dattoSite.normalizedData?.name || dattoSite.rawData?.name} to MSPByte site`);
        ...
        <div className="flex flex-col gap-4 size-full">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Link Datto RMM sites to MSPByte sites. Site variables are automatically pushed when linking.
                    </p>
                </div>
                ...
                <div className="flex gap-4">
                    ...
                    <div className="h-12 w-px bg-border" />
                    <div className="flex flex-col items-end">
                        <span className="text-2xl font-semibold">{transformedSites.length}</span>
