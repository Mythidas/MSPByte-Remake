          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1 space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Badge
                  variant="outline"
                  className={`${config.color} px-3 py-1`}
                >
        ...
        <TabsContent value="groups" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Security and distribution groups this user belongs to
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="roles" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Directory and administrative roles assigned to this user
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="licenses" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Microsoft 365 licenses and subscriptions assigned to this user
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="audit" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                History of actions and changes made to this user account
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
