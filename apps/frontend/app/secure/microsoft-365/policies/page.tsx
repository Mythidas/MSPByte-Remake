...
import { AlertCircle, CheckCircle, XCircle, FileText, Building2 } from "lucide-react";
...
export default function Microsoft365Policies() {
    ...
    const columns: DataTableColumn<PolicyEntity>[] = [
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                const statusConfig = {
                    enabled: { color: "bg-green-500/50", icon: CheckCircle, text: "Enabled" },
                    disabled: { color: "bg-red-500/50", icon: XCircle, text: "Disabled" },
                    "report-only": { color: "bg-blue-500/50", icon: FileText, text: "Report Only" },
                };
                const config = statusConfig[status as keyof typeof statusConfig] || statusConfig.enabled;
    ...
    return (
        <div className="flex flex-col size-full gap-2">
            <div>
                <h1 className="text-3xl font-bold tracking-tight">Microsoft 365 Policies</h1>
